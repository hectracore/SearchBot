...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/WdA.jpg')).split()  # Fsub pic
# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6161553871').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1003133546653'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '1003133546653'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003347671546'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '1003133546653'))  # Premium logs channel id
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '0'))  # Log channel id (make sure bot is admin)
...
SHORTLINK_API = environ.get('SHORTLINK_API', '21312ded78e50e34e58391be04bf4a266e6b5d8f')
