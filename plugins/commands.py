...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('• Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ •', url="https://t.me/CineZenHQ")
                  ]]
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            if STREAM_MODE:
                btn = [
                    ...
                    [InlineKeyboardButton('📌 Uᴘᴅᴀᴛᴇꜱ Cʜᴀɴɴᴇʟ 📌', url=f'https://t.me/CineZenHQ')]  # Keep this line unchanged
                ]
            else:
                btn = [
                    [InlineKeyboardButton('📌 Uᴘᴅᴀᴛᴇꜱ Cʜᴀɴɴᴇʟ 📌', url=f'https://t.me/CineZenHQ')]
                ]
            try:
        ...
        if is_valid == True:
            ...
            await client.send_message(chat_id=VERIFIED_LOG, text=Search_message)
