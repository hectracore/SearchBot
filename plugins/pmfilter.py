...
from SearchBot.util.file_properties import get_name, get_hash, get_media_file_size
from database.config_db import mdb
...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Jᴏɪɴ Aɴᴅ Sᴇᴀʀᴄʜ Hᴇʀᴇ", url=GRP_LNK)]]))
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    if settings["button"]:
        ...
        btn.insert(0, [
            InlineKeyboardButton("Rᴇᴍᴏᴠᴇ Aᴅs", url=f"https://t.me/{temp.U_NAME}?start=plan"),
            InlineKeyboardButton("Sᴇɴᴅ Aʟʟ", callback_data=f"sendfiles#{key}")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            Searchpro = await query.message.reply_text(
       ...
       #@codeflix_bots
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• Gʀᴏᴜᴘ •', callback_data='users'),
            InlineKeyboardButton('• Mᴏʀᴇ •', callback_data='help')
        ], [
            InlineKeyboardButton('• Tʀᴇɴᴅɪɴɢ Sᴇᴀʀᴄʜ •', callback_data='topsearch')
        ], [
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto('https://envs.sh/WdA.jpg')
        )
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('📲 Sᴇɴᴅ Pᴀʏᴍᴇɴᴛ Sᴄʀᴇᴇɴꜱʜᴏᴛ Hᴇʀᴇ', url=OWNER_LNK)
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('× Cʜᴀɴɴᴇʟ & Gʀᴏᴜᴘ ×', url="https://t.me/CineZenHQ")
       ],[
            InlineKeyboardButton('• Mᴏᴠɪᴇ RᴇQᴜᴇꜱᴛ Gʀᴏᴜᴘ ~ 1 •', url="https://t.me/srsuggestionsofficial"),
            InlineKeyboardButton('Admin', url="https://t.me/trazinox")
       ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• Cʜᴀɴɴᴇʟ •', url="t.me/CineZenHQ")
        ], [
            InlineKeyboardButton('• Bᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('Telegram Channel 📜', url='https://t.me/CineZenHQ'),
