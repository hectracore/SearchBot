...
from SujanBot.util.keepalive import ping_server
from SujanBot.Bot.clients import initialize_clients
...
if __name__ == '__main__':
    ...
    try:
        loop.run_until_complete(Sujan_start())
